...
install.packages(c("flextable","knitr","kableExtra","captioner","officer",
                   "openxlsx","bookdown", "pander","devtools"), dependencies=T)
...
saveOutput(df1, oFileName="tab.1.csv",
           caption="testing table w/o formatting info")

saveOutput(qplot(1:10,1:10), oFileName="fig.1.png",
...
saveOutput(df1, oFileName = "tab.2.csv",
